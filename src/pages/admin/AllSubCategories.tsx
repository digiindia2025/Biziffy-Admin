...
const AllSubcategories = () => {
  ...
  const handleEdit = (id: number) => {
    toast({
      ...
      description: `Edit subcategory #${id}`,
    });
  };
  ...
  const handleDelete = (id: number) => {
    toast({
      ...
      description: `Delete subcategory #${id}? This action cannot be undone.`,
    });
  };
  ...
  const handleExportToCSV = () => {
    toast({
      title: "Export to CSV",
      description: "Export subcategories to CSV file",
    });
  };
  ...
  const handleApplyBulkAction = () => {
    toast({
      ...
      description: "Apply bulk action to selected subcategories",
    });
  };
