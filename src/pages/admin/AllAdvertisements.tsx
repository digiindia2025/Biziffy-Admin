...
//     { id: 37, category: "Daily Home Needs", title: "test", type: "Listing Bottom", status: "Active", imageUrl: "/lovable-uploads/eecfa68c-b695-402c-bc7d-f128c55c2c6c.png" },
  ];
          ...
          <TableBody>
            {advertisements.map((ad) => (
              <TableRow key={ad.id}>
                ...
                <TableCell>
                  <div className="flex items-center gap-2">
                    <Button size="sm" variant="default" className="bg-orange-500 hover:bg-orange-600 text-white">
